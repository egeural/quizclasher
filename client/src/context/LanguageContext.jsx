...
const translations = {
  en: {
    ...
    suggestions: {
      ...
      subtitle: "Share your ideas, report bugs, or suggest new features. Your feedback helps us improve Quiz Clasher!",
      typeLabel: "Type",
      typeGeneral: "General Suggestion",
      typeFeature: "Feature Request",
      typeBug: "Bug Report",
      typeQuestion: "Question",
      typeOther: "Other",
      messageLabel: "Your message",
      messagePlaceholder: "Describe your suggestion, bug report, or question in detail...",
      submit: "Submit Suggestion",
      sending: "Sending...",
      successMessage: "Thank you! Your suggestion has been received. We'll review it soon.",
      errorEmpty: "Please enter a message.",
      errorTooShort: "Message must be at least 10 characters.",
      errorTooLong: "Message is too long. Please keep it under 1000 characters.",
      errorSend: "Failed to send suggestion. Please try again.",
      errorNetwork: "Network error. Please check your connection and try again.",
      maxLength: "1000",
      characters: "characters",
      noteTitle: "Privacy Note:",
      noteText: "Your email address is never exposed. All suggestions are sent securely through our server.",
    },
  },
  tr: {
    // Login
    ...
    createOwn: {
      ...
      completedCount: "Tamamlanan ({count})",
    ...
    // Love Couple
    loveCouple: {
      title: "Aşk Çifti Quiz Oluşturucu",
    ...
    suggestions: {
      ...
      subtitle: "Fikirlerinizi paylaşın, hata bildirin veya yeni özellikler önerin. Geri bildirimleriniz Quiz Clasher'ı geliştirmemize yardımcı olur!",
      typeLabel: "Tür",
      typeGeneral: "Genel Öneri",
      typeFeature: "Özellik İsteği",
      typeBug: "Hata Bildirimi",
      typeQuestion: "Soru",
      typeOther: "Diğer",
      messageLabel: "Mesajınız",
      messagePlaceholder: "Önerinizi, hata bildiriminizi veya sorunuzu detaylı olarak açıklayın...",
      submit: "Öneriyi Gönder",
      sending: "Gönderiliyor...",
      successMessage: "Teşekkürler! Öneriniz alındı. Yakında inceleyeceğiz.",
      errorEmpty: "Lütfen bir mesaj girin.",
      errorTooShort: "Mesaj en az 10 karakter olmalıdır.",
      errorTooLong: "Mesaj çok uzun. Lütfen 1000 karakterin altında tutun.",
      errorSend: "Öneri gönderilemedi. Lütfen tekrar deneyin.",
      errorNetwork: "Ağ hatası. Lütfen bağlantınızı kontrol edin ve tekrar deneyin.",
      maxLength: "1000",
      characters: "karakter",
      noteTitle: "Gizlilik Notu:",
      noteText: "E-posta adresiniz asla açığa çıkmaz. Tüm öneriler sunucumuz üzerinden güvenli bir şekilde gönderilir.",
    },
  },
};
